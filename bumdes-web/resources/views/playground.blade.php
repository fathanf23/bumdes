    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 text-center">
                <img src="{{ asset('frontend/images/catering.jpg') }}" class="img-fluid shadow" alt="Produk" style="max-width: 100%; height: auto; border-radius: 8px;">
            </div>

            <!-- Bagian Deskripsi Produk -->
            <div class="col-md-6 d-flex flex-column justify-content-center">
                <h3 class="fw-bold">TIMELESS MOKHA</h3>
                ...
                <p>
                    ...
                    The first coffee human beings ever tasted were single-origin coffees from Yemen, exported from the historic Port of Mokha.
                </p>
